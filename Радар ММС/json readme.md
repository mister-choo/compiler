...
#### [To/from streams (e.g. files, string streams)](https://github.com/nlohmann/json#tofrom-streams-eg-files-string-streams)
...
#### [Read from iterator range](https://github.com/nlohmann/json#read-from-iterator-range)
...
#### [Custom data source](https://github.com/nlohmann/json#custom-data-source)
...
#### [SAX interface](https://github.com/nlohmann/json#sax-interface)
...
### [STL-like access](https://github.com/nlohmann/json#stl-like-access)
...
### [](https://github.com/nlohmann/json#conversion-from-stl-containers)Conversion from STL containers
...
### [](https://github.com/nlohmann/json#json-pointer-and-json-patch)JSON Pointer and JSON Patch
...
### [](https://github.com/nlohmann/json#json-merge-patch)JSON Merge Patch
...
### [](https://github.com/nlohmann/json#implicit-conversions)Implicit conversions
...
### [](https://github.com/nlohmann/json#arbitrary-types-conversions)Arbitrary types conversions
...
#### [](https://github.com/nlohmann/json#basic-usage)Basic usage
...
#### [](https://github.com/nlohmann/json#simplify-your-life-with-macros)Simplify your life with macros
...
##### [](https://github.com/nlohmann/json#examples-1)Examples
...
#### [](https://github.com/nlohmann/json#how-do-i-convert-third-party-types)How do I convert third-party types?
...
#### [](https://github.com/nlohmann/json#how-can-i-use-get-for-non-default-constructiblenon-copyable-types)How can I use `get()` for non-default constructible/non-copyable types?
...
#### [](https://github.com/nlohmann/json#can-i-write-my-own-serializer-advanced-use)Can I write my own serializer? (Advanced use)
...
### [](https://github.com/nlohmann/json#specializing-enum-conversion)Specializing enum conversion
...
Just as in [Arbitrary Type Conversions](https://github.com/nlohmann/json#arbitrary-types-conversions) above,
...
### [](https://github.com/nlohmann/json#binary-formats-bson-cbor-messagepack-and-ubjson)Binary formats (BSON, CBOR, MessagePack, and UBJSON)
